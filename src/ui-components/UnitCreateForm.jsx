...
export default function UnitCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setNaturalLight(initialValues.naturalLight);
    setModernBuilding(initialValues.modernBuilding);
    setQuiet(initialValues.quiet);
    setBalcony(initialValues.balcony);
    setGoodViews(initialValues.goodViews);
    setNearbyParks(initialValues.nearbyParks);
    setAc(initialValues.ac);
    setCornerUnit(initialValues.cornerUnit);
    setWifi(initialValues.wifi);
